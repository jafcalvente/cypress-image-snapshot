...
- `customScreenshotDir`: Path to the directory that screenshot images will be written to, defaults to a sibling `__screenshot_output__` directory alongside each snapshot.
